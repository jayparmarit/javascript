         ...
         <div class="shadow-md group rounded-lg p-3 flex flex-col gap-3 items-center">
                ...
                <h4>${ele.phone}</h4>
                  ...
                  <div class="flex gap-3 invisible group-hover:visible">
                    <button onclick="editUser(${ele.id})" class="bg-gray-200 hover:bg-gray-400 rounded-full w-7 h-7">
                       <i class="bi bi-pen-fill"></i>
                    </button>
                    <button onclick="deleteUser(${ele.id})" class="bg-gray-200 hover:bg-gray-400 rounded-full w-7 h-7">
                       <i class="bi bi-trash"></i>
                    </button>
                    <button class="bg-gray-200 hover:bg-gray-400 rounded-full w-7 h-7">
